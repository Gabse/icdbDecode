...
void AnalyzerWrite(FILE* sourceFile, char* Key, unsigned int KeyLen)
{
	...
	case typecode_UID:
		...
		for (unsigned int i = 0; i < Data->LengthCalc; i++)
		{
			...
			fprintf(Datafile, ":: Owner: 0x%08X, ID: 0x%02X%04X, Type: 0x%02X => ", ((uid_union*)(Data->Data))[i].UID_Splitt.UID_Owner, ((uid_union*)(Data->Data))[i].UID_Splitt.UID_ID_MSB, ((uid_union*)(Data->Data))[i].UID_Splitt.UID_ID_LSB, ((uid_union*)(Data->Data))[i].UID_Splitt.UID_Type);
			fprintf(Txtfile, ":: Owner: 0x%08X, ID: 0x%02X%04X, Type: 0x%02X => ", ((uid_union*)(Data->Data))[i].UID_Splitt.UID_Owner, ((uid_union*)(Data->Data))[i].UID_Splitt.UID_ID_MSB, ((uid_union*)(Data->Data))[i].UID_Splitt.UID_ID_LSB, ((uid_union*)(Data->Data))[i].UID_Splitt.UID_Type);
			fprintf(Datafile, printUidType(((uid_union*)(Data->Data))[i].UID_Splitt.UID_Type));
			fprintf(Txtfile, printUidType(((uid_union*)(Data->Data))[i].UID_Splitt.UID_Type));
			fprintf(Datafile, " ]\n");
			fprintf(Txtfile, " ]\n");
		}
		break;
