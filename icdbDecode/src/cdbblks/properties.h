...
#include "cdbblks.h" 		// Required for color struct
...
******************************************************************
*/
extern void ProcessProperties(void);
extern void InitProperties(void);
extern unsigned int GetNumProperties(void);
extern properties_struct GetProperty(int);
